...
include 'momentums.mdl' !Phys 499
!=======================================================================
      program pictetra
      use cntrlsim
      use numerics
...
!  3.3 initialize spacecraft momentum 								PHYS 499
				write(6,*)'call mominit'
				call mominit
      endif
...
!Phys 499
					kprev(:)=ki(1:6,ii) !store the values of the particle from the previous time step
...
!  1.  header
      call charcompose('mom',timestep,'.vtk',filename)
...
!  4. momentum
      write(un,104)'CELL_DATA ',momnt
      write(un,101)'SCALARS P double'
